...
OPTEE_QUIC_PATH			?= $(ROOT)/optee_quic
...
BR2_PACKAGE_OPTEE_QUIC ?= y
BR2_PACKAGE_OPTEE_QUIC_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
BR2_PACKAGE_OPTEE_QUIC_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_OPTEE_QUIC_SITE ?= $(OPTEE_QUIC_PATH)
